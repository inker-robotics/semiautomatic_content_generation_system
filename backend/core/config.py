...
BACKEND_URL = os.getenv("RENDER_EXTERNAL_URL", os.getenv("BACKEND_URL", "http://127.0.0.1:8000"))
FRONTEND_URL = os.getenv("RENDER_EXTERNAL_URL", os.getenv("FRONTEND_URL", "http://localhost:3000"))
CORS_ORIGINS = [
    origin.strip()
